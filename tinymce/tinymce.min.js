...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        var x, w, _, N, E, S, k, T, R, A, B, D, L, H, M, P, O, I = "sizzle" + -new Date, F = window.document, z = {}, W = 0, V = 0, U = n(), q = n(), $ = n(), j = !1, K = function () {
            return 0
        ...
        E = o.isXML = function (e) {
            ...
            }), H = new RegExp(H.join("|")), M = M.length && new RegExp(M.join("|")), O = e(D.contains) || D.compareDocumentPosition ? function (e, t) {
            ...
            if ((e.ownerDocument || e) !== B && A(e), t = t.replace(Ct, "='$1']"), z.matchesSelector && L && (!M || !M.test(t)) && !H.test(t))try {
                var n = P.call(e, t);
        ...
        return c.fn = c.prototype = {constructor: c, selector: "", length: 0, init: function (e, t) {
            ...
            return h(e, "nextSibling", 1)
        }, prev: function (e) {
            return h(e, "previousSibling", 1)
        }, nextNodes: function (e) {
            return h(e, "nextSibling")
        }, prevNodes: function (e) {
            return h(e, "previousSibling")
        }, children: function (e) {
            return h(e.firstChild, "nextSibling", 1)
        }, contents: function (e) {
        ...
        function t(n) {
            ...
            function E(e) {
                ...
                for (o = C(H[V], H[W]), a = H[q] - H[W]; o && a > 0;)s = o.nextSibling, l = D(o, e), t && t.appendChild(l), --a, o = s;
            ...
            function k(e, t) {
                var n, i, o, a, s, l;
                for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = H[q] - i, o = e.nextSibling; o && a > 0;)s = o.nextSibling, l = D(o, t), n && n.appendChild(l), --a, o = s;
                return t != O && (H.setStartAfter(e), H.collapse(F)), n
            }

            function T(e, t, n) {
                var i, o, a, s, l, c, u, d;
                for (n != I && (o = r()), i = A(e, n), o && o.appendChild(i), a = e.parentNode, s = j(e), l = j(t), ++s, c = l - s, u = e.nextSibling; c > 0;)d = u.nextSibling, i = D(u, n), o && o.appendChild(i), u = d, --c;
            ...
            return $(H, {startContainer: M, startOffset: 0, endContainer: M, endOffset: 0, collapsed: F, commonAncestorContainer: M, START_TO_START: 0, START_TO_END: 1, END_TO_END: 2, END_TO_START: 3, setStart: i, setEnd: o, setStartBefore: a, setStartAfter: s, setEndBefore: l, setEndAfter: c, collapse: u, selectNode: d, selectNodeContents: f, compareBoundaryPoints: p, deleteContents: m, extractContents: h, cloneContents: g, insertNode: v, surroundContents: y, cloneRange: b, toStringIE: L}), H
        }
        ...
        return function (i, o) {
            ...
            i = i || {}, a.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var s = this, l, c = 0, u, d, f = [], p, m, h, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, D, L, H, M, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href"), V = /(java|vb)script:/i;
                for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), M = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, b = o.getShortEndedElements(), L = i.self_closing_elements || o.getSelfClosingElements(), C = o.getBoolAttrs(), w = i.validate, y = i.remove_internals, z = i.fix_self_closing, P = o.getSpecialElements(); l = H.exec(e);) {
                    if (c < l.index && s.text(F(e.substr(c, l.index - c))), u = l[6])u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), r(u); else if (u = l[7]) {
                        if (u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), x = u in b, z && L[u] && f.length > 0 && f[f.length - 1].name === u && r(u), !w || (_ = o.getElementRule(u))) {
                            if (N = !0, w && (k = _.attributes, T = _.attributePatterns), (S = l[8]) ? (v = -1 !== S.indexOf("data-mce-type"), v && y && (N = !1), p = [], p.map = {}, S.replace(M, a)) : (p = [], p.map = {}), w && !v) {
                                if (R = _.attributesRequired, A = _.attributesDefault, B = _.attributesForced, D = _.removeEmptyAttrs, D && !p.length && (N = !1), B)for (m = B.length; m--;)E = B[m], g = E.name, O = E.value, "{$uid}" === O && (O = "mce_" + I++), p.map[g] = O, p.push({name: g, value: O});
                        ...
                        if (d = P[u]) {
                            d.lastIndex = c = l.index + l[0].length, (l = d.exec(e)) ? (N && (h = e.substr(c, l.index - c)), c = l.index + l[0].length) : (h = e.substr(c), c = e.length), N && (h.length > 0 && s.text(h, !0), s.end(u)), H.lastIndex = c;
                            continue
                        }
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, _, N, E, S, k, T, R, A = [], B, D, L, H, M, P, O, I;
                if (o = o || {}, p = {}, m = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, k = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, M = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, L = /[ \t\r\n]+/g, H = /^[ \t\r\n]+$/, v = new n({validate: k, allow_script_urls: r.allow_script_urls, allow_conditional_comments: r.allow_conditional_comments, self_closing_elements: g(l.getSelfClosingElements()), cdata: function (e) {
                    ...
                    if (r = k ? l.getElementRule(t) : {}) {
                        ...
                        if (B && M[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O))if (r.paddEmpty)b.empty().append(new e("#text", "3")).value = "\xa0"; else if (!b.attributes.map.name && !b.attributes.map.id)return a = b.parent, b.empty().remove(), void(b = a);
                        b = b.parent
                    }
        ...
        return function (r, i) {
            ...
            function s() {
                ...
                L = !1, e("width", H), e("height", M), b.unbind(P, "mousemove", a), b.unbind(P, "mouseup", s), O != P && (b.unbind(O, "mousemove", a), b.unbind(O, "mouseup", s)), b.remove(w), I && "TABLE" != x.nodeName || l(x), i.fire("ObjectResized", {target: x, width: H, height: M}), i.nodeChanged()
            }

            function l(e, t, r) {
                var l, u, d, f, p, m = i.getBody();
                l = b.getPos(e, m), T = l.x, R = l.y, p = e.getBoundingClientRect(), u = p.width || p.right - p.left, d = p.height || p.bottom - p.top, x != e && (h(), x = e, H = M = 0), f = i.fire("ObjectSelected", {target: e}), o(e) && !f.isDefaultPrevented() ? C(_, function (e, o) {
                    function l(t) {
                        S = t.screenX, k = t.screenY, A = x.clientWidth, B = x.clientHeight, D = B / A, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {left: T, top: R, margin: 0}), w.removeAttribute("data-mce-selected"), i.getBody().appendChild(w), b.bind(P, "mousemove", a), b.bind(P, "mouseup", s), O != P && (b.bind(O, "mousemove", a), b.bind(O, "mouseup", s))
                    }

                    var c, f;
                    return t ? void(o == t && l(r)) : (c = b.get("mceResizeHandle" + o), c ? b.show(c) : (f = i.getBody(), c = b.add(f, "div", {id: "mceResizeHandle" + o, "data-mce-bogus": !0, "class": "mce-resizehandle", unselectable: !0, style: "cursor:" + o + "-resize; margin:0; padding:0"}), n.ie && (c.contentEditable = !1), b.bind(c, "mousedown", function (e) {
                        e.stopImmediatePropagation(), e.preventDefault(), l(e)
                    })), void b.setStyles(c, {left: u * e[0] + T - c.offsetWidth / 2, top: d * e[1] + R - c.offsetHeight / 2}))
            ...
            var b = i.dom, C = t.each, x, w, _, N, E, S, k, T, R, A, B, D, L, H, M, P = i.getDoc(), O = document, I = n.ie && n.ie < 11;
            ...
            }), {isResizable: o, showResizeRect: l, hideResizeRect: c, updateResizeRect: u, controlSelect: v, destroy: y}
        }
        ...
        function n(e) {
            this.walk = function (t, n) {
                ...
                function r(r) {
                    ...
                    function l(n, r) {
                        var a, s, l;
                        if (r = r || c, l = e.getParent(r.parentNode, e.isBlock) || f, n && "BR" == r.nodeName && v && e.isEmpty(l))return c = r.parentNode, u = e.nodeIndex(r), void(i = !0);
                    ...
                    var c, u, d, f = e.getRoot(), p, m, h, g, v;
                    if (c = n[(r ? "start" : "end") + "Container"], u = n[(r ? "start" : "end") + "Offset"], v = 1 == c.nodeType && u === c.childNodes.length, m = e.schema.getNonEmptyElements(), g = r, 1 == c.nodeType && u > c.childNodes.length - 1 && (g = !1), 9 === c.nodeType && (c = e.getRoot(), u = 0), c === f) {
                        if (g && (p = c.childNodes[u > 0 ? u - 1 : 0], p && (h = p.nodeName.toLowerCase(), m[p.nodeName] || "TABLE" == p.nodeName)))return;
                        if (c.hasChildNodes() && (u = Math.min(!g && u > 0 ? u - 1 : u, c.childNodes.length - 1), c = c.childNodes[u], u = 0, c.hasChildNodes() && !/TABLE/.test(c.nodeName))) {
                            p = c, d = new t(c, f);
                            do {
                                if (3 === p.nodeType && p.nodeValue.length > 0) {
                                    u = g ? 0 : p.nodeValue.length, c = p, i = !0;
                                    break
                                }
                                if (m[p.nodeName.toLowerCase()]) {
                                    u = e.nodeIndex(p), c = p.parentNode, "IMG" != p.nodeName || g || u++, i = !0;
                                    break
                                }
        ...
        return function (r) {
            ...
            function p(t, n, o) {
                ...
                function d(e, r, o) {
                    var l = [], c, d, f = !0;
                    c = h.inline || h.block, d = I.create(c), s(d), z.walk(e, function (e) {
                        function p(e) {
                            var y, C, x, _, N;
                        ...
                        function i(e) {
                            ...
                            }), t && !D(t) && x(t, h) && (n = I.clone(t, K), s(n), I.replace(n, e, Y), I.remove(t, 1)), n || e
                        }
                ...
                if (h)if (o)o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), d(T(y, m), null, !0)) : d(o, null, !0); else if (b && h.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length)M("apply", t, n); else {
                    var C = r.selection.getNode();
                    U || !m[0].defaultBlock || I.getParent(C, I.isBlock) || p(m[0].defaultBlock), r.selection.setRng(l()), v = F.getBookmark(), d(T(F.getRng(Y), m), v), h.styles && (h.styles.color || h.styles.textDecoration) && (nt(C, f, "childNodes"), f(C)), F.moveToBookmark(v), P(F.getRng(Y)), r.nodeChanged()
                }
            }
            ...
            function m(e, t, n) {
                ...
                return n ? void(n.nodeType ? (y = I.createRng(), y.setStartBefore(n), y.setEndAfter(n), f(y)) : f(n)) : void(F.isCollapsed() && m.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length ? M("remove", e, t) : (h = F.getBookmark(), f(F.getRng(Y)), F.moveToBookmark(h), m.inline && v(e, t, F.getStart()) && P(F.getRng(!0)), r.nodeChanged()))
            }
            ...
            function T(t, n, a) {
                function s(e) {
                    ...
                    for (; ;) {
                        ...
                        for (o = i[a]; o; o = o[a])if (!D(o) && !S(o) && !t(o))return i;
                        if (i.parentNode == s) {
                            r = i;
                            break
                        }
                ...
                if (1 == g.nodeType && g.hasChildNodes() && (p = g.childNodes.length - 1, g = g.childNodes[v > p ? p : v], 3 == g.nodeType && (v = 0)), 1 == y.nodeType && y.hasChildNodes() && (p = y.childNodes.length - 1, y = y.childNodes[b > p ? p : b - 1], 3 == y.nodeType && (b = y.nodeValue.length)), g = c(g), y = c(y), (D(g.parentNode) || D(g)) && (g = D(g) ? g : g.parentNode, g = g.nextSibling || g, 3 == g.nodeType && (v = 0)), (D(y.parentNode) || D(y)) && (y = D(y) ? y : y.parentNode, y = y.previousSibling || y, 3 == y.nodeType && (b = y.length)), n[0].inline && (t.collapsed && (h = u(g, v, !0), h && (g = h.container, v = h.offset), h = u(y, b), h && (y = h.container, b = h.offset)), m = l(y, b), m.node)) {
            ...
            function L(e, t) {
                function n(e, t) {
                    ...
                    return e.nodeName != t.nodeName ? K : r(n(e), n(t)) ? r(I.parseStyle(I.getAttrib(e, "style")), I.parseStyle(I.getAttrib(t, "style"))) ? !D(e) && !D(t) : K : K
                }
            ...
            function M(t, n, o) {
                ...
                function h() {
                    ...
                    if (d)if (l)s = F.getBookmark(), e.collapse(!0), e = T(e, c(n), !0), e = z.split(e), m(n, o, e), F.moveToBookmark(s); else {
                        for (h = a(), u = h, p = f.length - 1; p >= 0; p--)u.appendChild(I.clone(f[p], !1)), u = u.firstChild;
        ...
        return function (i) {
            function o(o) {
                ...
                function C() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (F = "LI"), H = F ? v(F) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, P) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(P)) : P.parentNode.insertBefore(H, P) : e() ? (a.insertAfter(H, t()), p(H)) : (P = t(), k = S.cloneRange(), k.setStartAfter(B), k.setEndAfter(P), M = k.extractContents(), "LI" == F && "LI" == M.firstChild.nodeName ? (H = M.firstChild, a.insertAfter(M, P)) : (a.insertAfter(M, P), a.insertAfter(H, P))), a.remove(B), h(H), c.add()
                }
                ...
                var S, k, T, R, A, B, D, L, H, M, P, O, I, F, z;
                if (S = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(S), R = S.startContainer, A = S.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", D = a.doc.documentMode, L = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = N(R)) {
                        ...
                        F && B === i.getBody() || (F = F || "P", y() ? (H = /^(H[1-6]|PRE|FIGURE)$/.test(O) && "HGROUP" != I ? v(F) : v(), l.end_container_on_empty_block && f(P) && a.isEmpty(B) ? H = a.split(P, B) : a.insertAfter(H, B), h(H)) : y(!0) ? (H = B.parentNode.insertBefore(v(), B), p(H), h(B)) : (k = S.cloneRange(), k.setEndAfter(B), M = k.extractContents(), _(M), H = M.firstChild, a.insertAfter(M, B), m(H), E(B), h(H)), a.setAttrib(H, "id", ""), i.fire("NewBlock", {newBlock: H}), c.add())
                    }
                }
            }
        ...
        return function (r) {
            ...
            o(this, {execCommand: p, queryCommandState: m, queryCommandValue: h, addCommands: g}), g({"mceResetDesignMode,mceBeginUndoLevel": function () {
                ...
                if (d = a.parse(i, C), h = d.lastChild, "mce_marker" == h.attr("id"))for (p = h, h = h.prev; h; h = h.walk(!0))if (3 == h.type || !w.isBlock(h.name)) {
        ...
        return function (a) {
            ...
            function u() {
                    ...
                    o.each(t.takeRecords(), function (e) {
                        ...
                        o.each(e.addedNodes, function (e) {
                            if ("SPAN" == e.nodeName && !e.getAttribute("mce-data-marked")) {
                                var t, i;
                                e == r && (t = n.startOffset, i = e.firstChild), V.remove(e, !0), i && (n.setStart(i, t), n.setEnd(i, t), a.selection.setRng(n))
                            }
                        })
                ...
                window.MutationObserver && (a.on("keydown", function (n) {
                    var r = n.keyCode == W, i = e.metaKeyPressed(n);
                    ...
                    c(n) || U.isCollapsed() || !n.charCode || e.metaKeyPressed(n) || (n.preventDefault(), t(!0), a.selection.setContent(String.fromCharCode(n.charCode)))
            ...
            function d() {
                function e(e) {
                    var t = V.create("body"), n = e.cloneContents();
                ...
                a.on("keydown", function (e) {
                    var t = e.keyCode, r, i;
                    if (!c(e) && (t == W || t == z)) {
                        if (r = a.selection.isCollapsed(), i = a.getBody(), r && !V.isEmpty(i))return;
                        if (!r && !n(a.selection.getRng()))return;
                        e.preventDefault(), a.setContent(""), i.firstChild && V.isBlock(i.firstChild) ? a.selection.setCursorLocation(i.firstChild, 0) : a.selection.setCursorLocation(i, 0), a.nodeChanged()
                    }
                })
            }
            ...
            function p() {
                a.settings.content_editable || (V.bind(a.getDoc(), "focusin", function () {
                    U.setRng(U.getRng())
                }), V.bind(a.getDoc(), "mousedown", function (e) {
                    e.target == a.getDoc().documentElement && (a.getBody().focus(), U.setRng(U.getRng()))
                }))
            }

            function m() {
                a.on("keydown", function (e) {
                    if (!c(e) && e.keyCode === z && U.isCollapsed() && 0 === U.getRng(!0).startOffset) {
                        var t = U.getNode(), n = t.previousSibling;
                        if ("HR" == t.nodeName)return V.remove(t), void e.preventDefault();
                        n && n.nodeName && "hr" === n.nodeName.toLowerCase() && (V.remove(n), e.preventDefault())
                    }
                })
            }
            ...
            function g() {
                a.on("click", function (e) {
                    e = e.target, /^(IMG|HR)$/.test(e.nodeName) && U.getSel().setBaseAndExtent(e, 0, e, 1), "A" == e.nodeName && V.hasClass(e, "mce-item-anchor") && U.select(e), a.nodeChanged()
                })
            }

            function v() {
                function e() {
                    var e = V.getAttribs(U.getStart().cloneNode(!1));
                    return function () {
                        var t = U.getStart();
                        t !== a.getBody() && (V.setAttrib(t, "style", null), F(e, function (e) {
                ...
                function t() {
                    return!U.isCollapsed() && V.getParent(U.getStart(), V.isBlock) != V.getParent(U.getEnd(), V.isBlock)
                }

                a.on("keypress", function (n) {
                    var r;
                    return c(n) || 8 != n.keyCode && 46 != n.keyCode || !t() ? void 0 : (r = e(), a.getDoc().execCommand("delete", !1, null), r(), n.preventDefault(), !1)
                }), V.bind(a.getDoc(), "cut", function (n) {
                    var r;
            ...
            function x() {
                l() > 7 || (s("RespectVisibilityInDesign", !0), a.contentStyles.push(".mceHideBrInPre pre br {display: none}"), V.addClass(a.getBody(), "mceHideBrInPre"), $.addNodeFilter("pre", function (e) {
            ...
            function w() {
                V.bind(a.getBody(), "mouseup", function () {
                    var e, t = U.getNode();
                    "IMG" == t.nodeName && ((e = V.getStyle(t, "width")) && (V.setAttrib(t, "width", e.replace(/[^0-9%]+/g, "")), V.setStyle(t, "width", "")), (e = V.getStyle(t, "height")) && (V.setAttrib(t, "height", e.replace(/[^0-9%]+/g, "")), V.setStyle(t, "height", "")))
                })
            }
            ...
            function _() {
                a.on("keydown", function (t) {
                    var n, r, i, o, s;
                    if (!c(t) && t.keyCode == e.BACKSPACE && (n = U.getRng(), r = n.startContainer, i = n.startOffset, o = V.getRoot(), s = r, n.collapsed && 0 === i)) {
                        for (; s && s.parentNode && s.parentNode.firstChild == s && s.parentNode != o;)s = s.parentNode;
                        "BLOCKQUOTE" === s.tagName && (a.formatter.toggle("blockquote", null, s), n = V.createRng(), n.setStart(r, 0), n.setEnd(r, 0), U.setRng(n))
                    }
                })
            }
            ...
            function N() {
                function e() {
                    a._refreshContentEditable(), s("StyleWithCSS", !1), s("enableInlineTableEditing", !1), q.object_resizing || s("enableObjectResizing", !1)
                }

                q.readonly || a.on("BeforeExecCommand MouseDown", e)
            }

            function E() {
                function e() {
                    F(V.select("a"), function (e) {
                        var t = e.parentNode, n = V.getRoot();
                        if (t.lastChild === e) {
                            for (; t && !V.isBlock(t);) {
                                if (t.parentNode.lastChild !== t || t === n)return;
                                t = t.parentNode
                            }
                            V.add(t, "br", {"data-mce-bogus": 1})
                        }
                    })
                }
            ...
            function S() {
                q.forced_root_block && a.on("init", function () {
                    s("DefaultParagraphSeparator", q.forced_root_block)
                })
            }
            ...
            function T() {
                a.on("keydown", function (e) {
                    var t;
                    c(e) || e.keyCode != z || (t = a.getDoc().selection.createRange(), t && t.item && (e.preventDefault(), a.undoManager.beforeChange(), V.remove(t.item(0)), a.undoManager.add()))
                })
            }

            function R() {
                var e;
                l() >= 10 && (e = "", F("p div h1 h2 h3 h4 h5 h6".split(" "), function (t, n) {
                    e += (n > 0 ? "," : "") + t + ":empty"
            ...
            function B() {
                ...
                function n() {
                    ...
                    a && !e.item && 0 === e.compareEndPoints("StartToEnd", e) && a.select(), V.unbind(r, "mouseup", n), V.unbind(r, "mousemove", t), a = o = 0
                }

                var r = V.doc, i = r.body, o, a, s;
                r.documentElement.unselectable = !0, V.bind(r, "mousedown contextmenu", function (i) {
                    if ("HTML" === i.target.nodeName) {
                        if (o && n(), s = r.documentElement, s.scrollHeight > s.clientHeight)return;
                        o = 1, a = e(i.x, i.y), a && (V.bind(r, "mouseup", n), V.bind(r, "mousemove", t), V.getRoot().focus(), a.select())
                    }
                })
            }
            ...
            function D() {
                a.on("keyup focusin", function (t) {
                    65 == t.keyCode && e.metaKeyPressed(t) || U.normalize()
                })
            }
            ...
            function I() {
                a.inline || a.on("init", function () {
                    a.getDoc().designMode = "on"
                })
            }

            var F = o.each, z = e.BACKSPACE, W = e.DELETE, V = a.dom, U = a.selection, q = a.settings, $ = a.parser, j = a.serializer, K = i.gecko, Y = i.ie, G = i.webkit;
            C(), _(), d(), D(), G && (u(), p(), g(), S(), i.iOS ? (y(), H(), M()) : f()), Y && i.ie < 11 && (m(), b(), x(), w(), T(), R(), A(), B()), i.ie >= 11 && (M(), I()), i.ie && (f(), O()), K && (m(), h(), v(), N(), E(), k(), L(), P())
        }
    }), r(rt, [p], function (e) {
        function t() {
            return!1
    ...
    }), r(ot, [y, C, x, k, S, D, L, H, M, P, O, I, b, l, tt, w, N, nt, g, p, rt, it], function (e, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        var E = e.DOM, S = n.ThemeManager, k = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, D = C.trim, L = C.resolve, H = m.Event, M = b.gecko, P = b.ie;
        return N.prototype = {render: function () {
            ...
            function t() {
                ...
                C.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), R(r.external_plugins, function (e, t) {
                    ...
                    if (e = D(e), e && !k.urls[e])if ("-" == e.charAt(0)) {
            ...
            if (!H.domLoaded)return void E.bind(window, "ready", e);
            ...
            function e(n) {
                var r = k.get(n), i, o;
                i = k.urls[n] || t.documentBaseUrl.replace(/\/$/, ""), n = D(n), r && -1 === B(m, n) && (R(k.dependencies(n), function (t) {
                    e(t)
            ...
            if (n)return t.callbackLookup && (r = t.callbackLookup[e]) && (n = r.func, r = r.scope), "string" == typeof n && (r = n.replace(/\.\w+$/, ""), r = r ? L(r) : 0, n = L(n), t.callbackLookup = t.callbackLookup || {}, t.callbackLookup[e] = {func: n, scope: r}), n.apply(r || t, Array.prototype.slice.call(arguments, 1))
            ...
            function c(n) {
                ...
                c.on("init", function () {
                    "onbeforedeactivate"in document && t.ie < 11 ? (c.dom.bind(c.getBody(), "beforedeactivate", function () {
                        try {
                            c.pendingRng = c.selection.getRng()
                        } catch (e) {
                        }
                    }), c.dom.bind(c.getBody(), "blur", function () {
                        c.pendingRng && (c.lastRng = c.pendingRng, c.selection.lastFocusBookmark = o(c.lastRng), c.pendingRng = null)
                    ...
                    c.selection.lastFocusBookmark && (c.selection.setRng(a(c, c.selection.lastFocusBookmark)), c.selection.lastFocusBookmark = null), e != c && (e && e.fire("blur", {focusedEditor: c}), r.activeEditor = c, r.focusedEditor = c, c.fire("focus", {blurredEditor: e}), c.focus(!0)), c.lastRng = null
        ...
        var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, m, h = {majorVersion: "4", minorVersion: "0.18", releaseDate: "2014-02-27", editors: [], i18n: s, activeEditor: null, setup: function () {
            var e = this, t, n, i = "", o;
            ...
            function o() {
                var m, h;
                if (c.unbind(window, "ready", o), r(t, "onpageload"), t.types)return void d(t.types, function (r) {
        ...
        return e.extend({Defaults: {classes: "widget btn", role: "button"}, init: function (e) {
            ...
            return e.settings.image && (r = "none", i = " style=\"background-image: url('" + e.settings.image + "')\""), r = e.settings.icon ? n + "ico " + n + "i-" + r : "", '<div id="' + t + '" class="' + e.classes() + '" tabindex="-1" aria-labelledby="' + t + '"><button role="presentation" type="button" tabindex="-1">' + (r ? '<i class="' + r + '"' + i + "></i>" : "") + (e._text ? (r ? "\xa0" : "") + e.encode(e._text) : "") + "</button></div>"
        }})
    }), r(xt, [j], function (e) {
        ...
        return e.extend({init: function (e) {
            ...
            return'<div id="' + t + '" class="' + e.classes() + '" role="button" tabindex="-1" aria-haspopup="true"><button role="presentation" hidefocus type="button" tabindex="-1">' + (r ? '<i class="' + r + '"' + i + "></i>" : "") + '<span id="' + t + '-preview" class="' + n + 'preview"></span>' + (e._text ? (r ? " " : "") + e._text : "") + '</button><button type="button" class="' + n + 'open" hidefocus tabindex="-1"> <i class="' + n + 'caret"></i></button></div>'
        }, postRender: function () {
        ...
        return e.extend({recalc: function (e) {
            var t, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v = [], y, b, C, x, w, _, N, E, S, k, T, R, A, B, D, L, H, M, P, O, I, F, z, W, V = Math.max, U = Math.min;
            ...
            if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[D] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
    ...
    }), r(Mt, [U, bt, Q, p, lt, g], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t) {
                function n(e) {
        ...
        return e.extend({recalc: function (e) {
            var t = e.settings, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v, y, b, C, x, w, _, N = [], E = [], S, k, T, R, A, B;
        ...
        return e.extend({Defaults: {classes: "widget btn splitbtn", role: "button"}, repaint: function () {
            ...
            return'<div id="' + t + '" class="' + e.classes() + '" role="button" tabindex="-1"><button type="button" hidefocus tabindex="-1">' + (r ? '<i class="' + r + '"></i>' : "") + (e._text ? (r ? " " : "") + e._text : "") + '</button><button type="button" class="' + n + 'open" hidefocus tabindex="-1">' + (e._menuBtnText ? (r ? "\xa0" : "") + e._menuBtnText : "") + ' <i class="' + n + 'caret"></i></button></div>'
        }, postRender: function () {
            var e = this, t = e.settings.onclick;
    ...
    }), a([l, c, u, d, f, p, m, h, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, D, L, H, M, P, O, I, F, z, W, V, U, q, $, j, K, Y, G, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, mt, ht, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, St, kt, Tt, Rt, At, Bt, Dt, Lt, Ht, Mt, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, qt, $t, jt, Kt, Yt, Gt, Xt, Jt, Qt])
}(this);