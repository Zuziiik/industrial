...
class RecipeItemDAO {
    ...
    public static function selectByIds($itemId, $recipeId) {
        ...
        $row = rowQueryMysql("SELECT recipe_id_recipe, item_item_id, table_pos  FROM recipe_item WHERE item_item_id='$itemId' AND recipe_id_recipe='$recipeId'");
    ...
    public static function selectByRecipeId($recipeId) {
        ...
        $result = queryMysql("SELECT recipe_id_recipe, item_item_id, table_pos FROM recipe_item WHERE recipe_id_recipe='$recipeId'");
